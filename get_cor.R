...
get_all_pairs.exp <- function(all_pairs.exp) {
  ...
  exp_id <- fread("/home/dhthutrang/ENCODE/utilities/exp_id.2021_.txt", sep = "\t", quote = FALSE, header = FALSE)
...
# p_val = readRDS("/home/dhthutrang/Krebs/Shen/cor_analysis/all_res_list.pearcor_r.RDS")
# lapply(p_val, head)
# p_val = readRDS("/home/dhthutrang/Krebs/Shen/cor_analysis/all_res_list.pearcor_p.RDS")
# lapply(p_val, head)


# temp = lapply(p_val, function(x) x[[1]][!is.na(x[[2]])])
